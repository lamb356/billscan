/**
 * pdf.ts — thin compatibility shim.
 *
 * The full PDF extraction implementation lives in ocr-pipeline.ts.
 * This module retains the original parsePdf() signature for any legacy callers.
 */
