...
function BillScanLogo() {
  return (
    <svg width="32" height="32" viewBox="0 0 28 28" fill="none" aria-label="BillScan">
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          <Link href="/" style={{
            ...
            <BillScanLogo />
            <span style={{ fontSize: '1.375rem', fontWeight: 700, letterSpacing: '-0.03em' }}>
              Bill<span style={{ color: 'var(--accent)' }}>Scan</span>
            </span>
          </Link>
        </div>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            ...
            <p style={{ fontSize: '0.875rem', margin: 0 }}>
              Audit your medical bills in seconds.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: '0.8125rem', color: 'var(--text-muted)', fontWeight: 500 }}>Free</span>
              <span style={{ fontSize: '0.8125rem', color: 'var(--text-muted)' }}>3 bill audits per month</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: '0.8125rem', color: 'var(--green)', fontWeight: 600 }}>Pro · $9.99/mo</span>
              <span style={{ fontSize: '0.8125rem', color: 'var(--text-muted)' }}>Unlimited audits + dispute tools</span>
            </div>
          </div>
        </div>
