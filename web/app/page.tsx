...
export const metadata: Metadata = {
  ...
  description:
    'BillScan audits your medical bills against 1,057,383 CMS Medicare rates. Find overcharges instantly. Free to start.',
};
    ...
    <>
      ...
      <main>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
                <svg width="40" height="16" viewBox="0 0 40 16" fill="none">
                  <path d="M0 8 L32 8 M28 2 L36 8 L28 14" stroke="var(--text-faint)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
          ...
          <div className="container" style={{ maxWidth: 860 }}>
            <div style={{ textAlign: 'center', marginBottom: 'var(--space-12)' }}>
              ...
              <p style={{ marginTop: 12, maxWidth: 520, margin: '12px auto 0' }}>
                Three steps from confused patient to armed negotiator.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Upload your itemized hospital bill as a PDF, image, or JSON. We support EOBs too.',
                },
                {
                  step: '02',
                  title: 'We compare every line',
                  desc: 'Each CPT code is matched against the official CMS fee schedules for your region.',
                },
                {
                  step: '03',
                  title: 'Get your overcharge report',
                  desc: 'See exactly which charges are inflated, by how much, and how strong your dispute case is.',
                },
              ].map((item) => (
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
                  <Feature
                    ...
                    desc="Every CPT code Medicare pays for, updated annually. The ground truth for what procedures actually cost."
                  />
                  <Feature
                    icon="🏥"
                    title="OPPS Hospital Outpatient Rates"
                    desc="What Medicare pays hospitals for outpatient services — not what they bill."
                  />
                  <Feature
                    icon="💊"
                    title="ASP Drug Pricing + CLFS Lab Fees"
                    desc="Average sales price for drugs, clinical laboratory fee schedule — all four data sources, cross-referenced."
                  />
                  <Feature
                    icon="📍"
                    title="ZIP-to-locality matching"
                    desc="Rates vary by region. We map your ZIP to the correct Medicare locality for accurate comparison."
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
                  <Feature
                    ...
                    desc="Every finding is classified as low, medium, high, or extreme — so you know what to dispute first."
                  />
                  <Feature
                    icon="📄"
                    title="Dispute letter generation"
                    desc="Pro users get a ready-to-send dispute letter citing specific CMS codes and overcharge amounts."
                  />
                  <Feature
                    icon="📞"
                    title="Phone script for billing department"
                    desc="Exactly what to say when you call, with the right terminology to sound like you know your rights."
                  />
                  <Feature
                    icon="🆓"
                    title="Charity care checker"
                    desc="Many hospitals must provide financial assistance. We check if you qualify based on your state and income."
                  />
                </div>
              </div>
            </div>
        ...
        <section style={{
          ...
          textAlign: 'center',
          background: 'radial-gradient(ellipse 60% 60% at 50% 100%, rgba(16,185,129,0.07) 0%, transparent 70%)',
        }}>
          <div className="container" style={{ maxWidth: 600 }}>
            <h2 style={{ marginBottom: 16 }}>Start auditing for free</h2>
            <p style={{ marginBottom: 36 }}>
              3 free audits per month. No credit card required. Pro users get unlimited audits,
              dispute letters, and phone scripts.
            </p>
            <Link href="/audit" className="btn btn-primary btn-lg">
              Upload Your Bill
            </Link>
